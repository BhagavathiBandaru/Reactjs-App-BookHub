...
class BookShelvesRoute extends Component {
  ...
  renderFailureView = () => (
    <div className="top-rated-books-failure-container">
      <img
        ...
        src="https://assets.interviewbit.com/packs/images/cover.9f999f.svg"
        alt="failure view"
      />
  ...
  renderNoMatchBooks = () => {
    ...
    return (
      <div className="no-match-found-page">
        <img
        ...
        <div>
          <div className="book-shelves-bg-container-lg">
            <div className="book-shelves-filter-container">
              <h1
                className="book-shelve-heading bookshelves-heading-dskTop"
                key="title"
              >
                Bookshelves
              </h1>
